...
- Tools
  - [Circle CI/Deploy](https://circleci.com/gh/nykolaslima/akka-api-template),
  - [Container Registry](https://console.cloud.google.com/kubernetes/images/tags/api?location=US&project=akka-api-template&authuser=1),
...
- `make dependencies/resources`: Download the [Protobuf files](https://github.com/nykolaslima/akka-api-template-resources) and generate the Scala classes that will be used by the project. (Please look at [Makefile](https://github.com/nykolaslima/akka-api-template/blob/master/Makefile) in order to configure `proto_version`)
...
docker run \
  -p 8080:8080 \
  -e environment=qa \
  nykolaslima/akka-api-template:latest \
  -Dakka.loglevel=WARN
```
